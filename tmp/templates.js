angular.module('templates-main', ['../app/views/404.html', '../app/views/about.html', '../app/views/friends.html', '../app/views/friendsConfirmationModal.html', '../app/views/home.html', '../app/views/intro.html', '../app/views/leftMenu.html', '../app/views/login.html', '../app/views/menu.html', '../app/views/subscribedFriends.html']);

angular.module("../app/views/404.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("../app/views/friends.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/views/friends.html",
    ...
    "                 </label>-->\n" +
    "\n" +
    "             <li class=\"item item-thumbnail-left selectable item-icon-right\" ng-click=\"addFriend(friend,$event)\" ng-repeat=\"friend in filteredFriends\">\n" +
...
angular.module("../app/views/friendsConfirmationModal.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/views/friendsConfirmationModal.html",
    "<div class=\"modal\">\n" +
    "\n" +
...
angular.module("../app/views/home.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/views/home.html",
    ...
    "        <br/>\n" +
    "\n" +
    "        <div ng-cloack class=\"row\" ng-if=\"!user.logged\">\n" +
    "            <div class=\"col text-center\">\n" +
    ...
    "            <i class=\"ion-help-buoy\"></i> Relancer le tutorial\n" +
    "        </a>\n" +
    "    </div>\n" +
    "</ion-view>");
}]);

angular.module("../app/views/intro.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/views/intro.html",
...
angular.module("../app/views/leftMenu.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/views/leftMenu.html",
...
angular.module("../app/views/menu.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("../app/views/subscribedFriends.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/views/subscribedFriends.html",
